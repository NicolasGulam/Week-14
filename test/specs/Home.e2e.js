...
describe('My Login application', () => {
    ...
    it('Should change filter button Name (Z to A)', async () => {
        ...
        await InventoryPage.optionFilterNameZA.waitForDisplayed();
        await InventoryPage.optionFilterNameZA.click();
        await expect(InventoryPage.filtersText).toHaveText('NAME (Z TO A)');
    });
    it('Should change filter button Price (low to high)', async () => {
        await InventoryPage.btnFilters.waitForDisplayed();
        await InventoryPage.btnFilters.click();
        await InventoryPage.optionFilterNameLowHigh.waitForDisplayed();
        await InventoryPage.optionFilterNameLowHigh.click();
    ...
    it('Should change filter button Price (high to low)', async () => {
        await InventoryPage.btnFilters.waitForDisplayed();
        await InventoryPage.btnFilters.click();
        await InventoryPage.optionFilterNameHighLow.waitForDisplayed();
        await InventoryPage.optionFilterNameHighLow.click();
        await expect(InventoryPage.filtersText).toHaveText('PRICE (HIGH TO LOW)');
    });
    it('Should change filter button Name (A to Z)', async () => {
        await InventoryPage.btnFilters.waitForDisplayed();
        await InventoryPage.btnFilters.click();
        await InventoryPage.optionFilterNameAZ.waitForDisplayed();
        await InventoryPage.optionFilterNameAZ.click();
